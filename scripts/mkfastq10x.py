...
with open(snakemake.output.csv, 'w') as f:
    f.write('Lane,Sample,Index\n'
            f"{snakemake.params.lane},{snakemake.wildcards.run10x},{snakemake.params.index}")
...
fastq_glob = f"{snakemake.output.mkfastq10x_dir}/outs/fastq_path/*/*/*.fastq.gz"
...
print(f"\nCreating merged FASTQs {snakemake.output.fastqR1}, {snakemake.output.fastqR2}\n")

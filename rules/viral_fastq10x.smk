...
rule viral_barcodes_in_supernatant:
    """Extract viral barcodes from supernatant sequencing data."""
    input:
        ...
        notebook='notebooks/viral_barcodes_in_supernatant.py.ipynb'
    output:
        viral_bc_in_supernatant_csv=join(config['viral_fastq10x_dir'],
                                      "{expt}_viral_bc_in_supernatant.csv.gz"),
        viral_bc_in_secondinfection_csv=join(config['viral_fastq10x_dir'],
    ...
    log:
        notebook=join(config['viral_fastq10x_dir'],
                      "{expt}_viral_barcodes_in_supernatant.py.ipynb")
    conda: '../environment.yml'
    notebook:
        '../notebooks/viral_barcodes_in_supernatant.py.ipynb'

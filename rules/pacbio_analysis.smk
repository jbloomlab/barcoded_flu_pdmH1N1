...
rule align_pacbio:
    ...
    output:
        ...
        plot_alignment=report(join(config['pacbio_dir'],
                              ...
                              caption='../report/align_pacbio.rst',
                              category="{expt}"),
        readstats_csv=join(config['pacbio_dir'],
                           "{expt}_readstats.csv"),
        frac_CCS_filtered_by_gene=join(config['pacbio_dir'],
                           "{expt}_frac_CCS_filtered_by_gene.csv"),
        filter_reasons_csv=join(config['pacbio_dir'],
                                "{expt}_filter_reasons.csv"),
        frac_CCS_filtered_by_reason=join(config['pacbio_dir'],
                           "{expt}_frac_CCS_filtered_by_reason.csv"),
        mutation_df=join(config['pacbio_dir'],
                         "{expt}_mutations_by_ccs.csv.gz"),
